...
final productNotifier = StateNotifierProvider<ProductNotifier,List<Product>>((ref) => ProductNotifier());
...
class ProductNotifier extends StateNotifier<List<Product>> {
  ProductNotifier()
    : super([
        Product(
          ...
          description:
              'Experience premium sound quality with noise cancellation.',
          price: 120.0,
        ...
        Product(
          name: 'Gaming Laptop',
          description:
              'High-end gaming laptop with cutting-edge graphics and speed.',
          price: 1500.0,
        ...
        Product(
          name: 'Smartwatch',
          description:
              'Track your health and fitness with style and precision.',
          price: 250.0,
        ...
        Product(
          ...
          description:
              'Fast and energy-efficient kettle for your perfect tea or coffee.',
          price: 30.0,
        ...
        Product(
          name: 'Air Purifier',
          description:
              'Breathe clean air with this advanced filtration system.',
          price: 200.0,
        ...
        Product(
          name: '4K LED TV',
          description:
              'Immerse yourself in stunning visuals with ultra-high-definition display.',
          price: 900.0,
        ...
        Product(
          name: 'Coffee Maker',
          description:
              'Brew barista-quality coffee in the comfort of your home.',
          price: 150.0,
          color: Colors.brown,
        ),
      ]);
  ...
  List<Product> get selectedproduct =>
      state.where((product) => product.isSelected).toList();
...
final List<Product> _productlist = [
  ...
  List<Product> get selectedProduct =>
      _productlist.where((product) => product.isSelected).toList();
